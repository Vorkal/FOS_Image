...
This repository is based off the image template at [Universal Blue Image Template](https://github.com/ublue-os/image-template). This template is the recommended way to make customizations to any image published by the Universal Blue Project.
...
Check out the [Universal Blue Image Template](https://github.com/ublue-os/image-template). That will have the base instructions. This is simply for my own use case to test building an immutable distro with more enterprise features.
